...
// Add this to your layout slice or actions file
export const initializeLayoutMode = () => (dispatch) => {
  ...
  if (savedMode) {
    ...
    const defaultMode = prefersDark
      ? layoutModeTypes.DARKMODE
      : layoutModeTypes.LIGHTMODE;
    dispatch(changeLayoutMode(defaultMode));
  }
};
