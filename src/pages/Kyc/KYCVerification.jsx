              ...
              <Row className="text-center justify-content-center py-4">
                <Col lg={12}>
                  ...
                  <p className="text-muted mb-4">
                    Your verification is being reviewed, The process takes 2 - 4
                    hours upon which your verification status will be updated.
                    You can check the progress on your dashboard.
                  ...
                  <div className="hstack justify-content-center gap-2">
                    ...
                    >
                      <i className="ri-home-4-line align-bottom ms-1"></i> Back
                      to Home
                    </button>
                  </div>
                </Col>
